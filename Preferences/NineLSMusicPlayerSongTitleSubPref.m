#include "NineLSMusicPlayerSongTitleSubPref.h"
#import <Preferences/PSSpecifier.h>

#define kTintColor [UIColor colorWithRed: 0.42 green: 0.54 blue: 0.80 alpha: 1.00];

@implementation NineLSMusicPlayerSongTitleSubPref

- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"MusicPlayerSongTitle" target:self];
	}
