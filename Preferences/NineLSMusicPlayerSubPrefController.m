#include "NineLSMusicPlayerSubPrefController.h"
#import <Preferences/PSSpecifier.h>

#define kTintColor [UIColor colorWithRed: 0.42 green: 0.54 blue: 0.80 alpha: 1.00];

@implementation NineLSMusicPlayerSubPrefController

- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"MusicPlayer" target:self];
	}
